...
//                 <div class='output'><textarea class='output-textarea output-keyword' rows='1' style='width:${valueInitialInputField.length + 1}rem;'>${valueInitialInputField}</textarea></div>`);
//             }
//             else{
//                 initialInputField.insertAdjacentHTML('beforebegin', `
